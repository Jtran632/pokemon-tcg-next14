...
--> statement-breakpoint
DROP TABLE "test_account";--> statement-breakpoint
DROP TABLE "test_session";--> statement-breakpoint
DROP TABLE "users";--> statement-breakpoint
DROP TABLE "test_verificationToken";--> statement-breakpoint
ALTER TABLE "favCards" DROP CONSTRAINT "favCards_userId_users_id_fk";
--> statement-breakpoint
ALTER TABLE "favCards" ALTER COLUMN "userId" SET DATA TYPE varchar(255);--> statement-breakpoint
...
DO $$ BEGIN
 ALTER TABLE "favCards" ADD CONSTRAINT "favCards_userId_user_id_fk" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
